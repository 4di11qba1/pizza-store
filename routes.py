...
from resources import AddAdmin, AdminLogin, AdminLogout, AddPizza, RemovePizza, GetPizzas, AddToCart, GetPizzasInCart, RemoveFromCart, GetOrders, PlaceOrder, AddRider, GetRiders, AssignOrderToRider
...
api.add_resource(AddAdmin, '/api/addAdmin')       # POST - Add admin
api.add_resource(AdminLogin, '/api/login')       # POST - Login
api.add_resource(AdminLogout, '/api/logout')      # POST - Logout
...
api.add_resource(AssignOrderToRider, '/api/assignOrder')  # POST - Assign order to rider